<?php include('connection.php');
	...
	if (isset($_POST['btnValider'])){
		$sql= "INSERT INTO cv (facebook,twiter,github) VALUES ('".$_POST['facebook']."'
	'".$_POST['twiter']."'
    '".$_POST['github']."')";
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<form action="" method="POST" role="form">
						<legend class="titre"><h1>CREER CV</h1></legend>
						<span> <?php echo $msg; ?> </span>
					
						<div class="form-group">
							<label for="">facebook</label>
							<input name="facebook" type="text" class="form-control" id="" placeholder="" value="<?php if (isset($_GET['id'])) echo $dataU['facebook']; ?>">
						</div>
						<div class="form-group">
							<label for="">twiter</label>
							<input name="twiter" type="text" class="form-control" id="" placeholder="" value="<?php if (isset($_GET['id'])) echo $dataU['twiter']; ?>">
						</div>
						<div class="form-group">
							<label for="">github</label>
							<input name="github" type="text" class="form-control" id="" placeholder="" value="<?php if (isset($_GET['id'])) echo $dataU['github']; ?>">
						</div>
